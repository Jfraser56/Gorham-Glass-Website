  ...
  return (
    <div className="w-full h-full space-y-5 ">
      ...
      <p className="text-lg">
        ...
        just replace window glass, we clean it too! Our professional cleaners
        are more than capable of handling the dirtiest glass you can throw at
        them. From residential home windows to commercial shop fronts, we’ll
        have your windows sparkling like the day they were installed.
      </p>
      <p className="text-lg">
      ...
      <div className="h-full flex flex-col lg:flex-row bg-slate-100 p-8">
        <div className="h-96 w-full p-5">
          ...
          <ul className="space-y-3">
            ...
            <li>Easier to spot cracks and broken window seals early</li>
